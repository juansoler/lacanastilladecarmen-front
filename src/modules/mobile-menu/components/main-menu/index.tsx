  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="flex items-center justify-between w-full border-b border-gray-200 py-4 px-6">
        ...
        <div>
          <h1 className="text-xl-semi uppercase">La Canastilla de Carmen</h1>
        </div>
                      ...
                      <a>
                        ...
                        >
                          <span className="sr-only">
                            Ir a {collection.title} colección
                          </span>
        ...
        <div className="flex flex-col">
          <div className="flex flex-col gap-y-8 text-small-regular">
            {!customer ? (
                ...
                <Link href={`/account/login`} passHref>
                  <a>
                    <button
                      ...
                      onClick={close}
                    >
                      <span className="sr-only">Ir a la página de Registro</span>
              ...
              <div className="flex flex-col gap-y-4">
                <span className="text-gray-700 uppercase">Entrar como...</span>
                <Link href={`/account`} passHref>
                  <a>
                    <button
                      ...
                      onClick={close}
                    >
                      <span className="sr-only">Ir a la cuenta</span>
            ...
            <div className="flex flex-col gap-y-4">
              <span className="text-gray-700 uppercase">Gastos de envío</span>
              <button
                className="flex items-center justify-between border-b border-gray-200 py-2"
                onClick={setScreenCountry}
              >
                <span className="sr-only">
                  Elige para elegir el país
                </span>
